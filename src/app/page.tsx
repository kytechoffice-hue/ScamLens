...
export default function HomeDashboardPage() {
  return (
    <div className="flex-1 py-6 px-3 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8 w-full">
      ...
      {/* 1. DASHBOARD SUMMARY CARDS (Required Item 4) */}
      <section>
      ...
      {/* 2. INDIA MAP + LIVE THREAT FEED (Required Items 5 & 6) */}
      ...
      {/* 3. TOP INDIAN SCAM CATEGORIES (Required Item 7) */}
      <section className="pt-2">
        <TopScamCategories />
      </section>

      {/* 4. THREAT ANALYTICS & SEVERITY (Required Items 8 & 9) */}
      <section className="pt-2">
        <ThreatAnalyticsCharts />
      </section>

      {/* 5. RECENT THREAT TABLE (Required Item 10) */}
      <section className="pt-2">
        <RecentThreatTable />
      </section>
